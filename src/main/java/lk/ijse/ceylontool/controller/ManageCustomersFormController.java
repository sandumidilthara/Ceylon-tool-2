...
import lk.ijse.ceylontool.view.tm.CustomerTM;
...
public class ManageCustomersFormController {
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            /*    Connection connection = DBConnection.getDbConnection().getConnection();
                ...
                pstm.executeUpdate(); */
                CustomerRepo.saveCustomer(id,name,address);
            ...
            try {
                ...
                pstm.setString(3, id);
                pstm.executeUpdate(); */
                CustomerRepo.updateCustomer(name,address,id);
            } catch (SQLException e) {
    ...
    boolean existCustomer(String id) throws SQLException, ClassNotFoundException {
       ...
       return CustomerRepo.exitCustomer(id);
    }
    ...
    private String generateNewId() {
        try {
            ...
            ResultSet rst=  CustomerRepo.generateNewId();
            if (rst.next()) {
